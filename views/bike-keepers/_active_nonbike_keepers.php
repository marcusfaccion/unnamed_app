  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="bike-keeper-heading-<?=$bike_keeper->id?>">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#nonbike-keeper-accordion" href="#collapse-bike-keeper-<?=$bike_keeper->id?>" aria-expanded="true" aria-controls="collapse-bike-keeper-<?=$bike_keeper->id?>">
            O bike_keepera <span class="text-primary"><strong>#<?=$bike_keeper->id?></strong></span> cadastrado em <?=Yii::$app->formatter->asDate($bike_keeper->created_date)?> foi criticado <strong><?=Yii::t('app','{n,plural,=1{uma vez} other{# vezes}}',['n'=>count($bike_keeper->nonExistence)])?></strong> como não existente. 
        </a>
      </h4>
    </div>
    <div id="collapse-bike-keeper-<?=$bike_keeper->id?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-bike-keeper-<?=$bike_keeper->id?>">
      <div class="panel-body">
          ...
          <a id='nonbike_keeper-<?=$bike_keeper->id?>-btn-disable' data-toggle="tooltip" data-placement="left" title="Desativar bike-keepera" role="button" class="btn btn-xs btn-default nonbike-keeper-disable" data-original-title="Desativar bike-keepera"><span class="text-danger glyphicon glyphicon-remove-circle"></span></a>
          <span data-toggle="modal" data-target="#bike_keeper_view_users_modal">
            <a id='nonbike_keeper-<?=$bike_keeper->id?>-btn-users' data-toggle="tooltip" data-placement="left" title="Ver informantes" role="button" class="btn btn-xs btn-default nonbike-keeper-view-users" data-original-title="Ver informantes"><span class="text-muted glyphicon glyphicon-user"></span></a>
          </span>
