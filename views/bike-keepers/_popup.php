...
<div class="row top-buffer-1">
    <div class="col-lg-12 col-xs-12">
        <p class="bg-default text-center"><strong><span class="glyphicon glyphicon-exclamation-sign"></span> <?=$bike_keeper->capacity?></strong></p>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 col-xs-12">
        <div class="col-lg-3 col-xs-3">
            ...
            <?=Yii::$app->formatter->asDate($bike_keeper->created_date)?>
        </div>
    ...
    <div class="col-lg-12 col-xs-12">
        <?php if($user_avaliation && !$user_bike_keeper_existence): ?>
            <?php if($user_avaliation->rating=='likes'): ?>
                <div class="col-lg-3 col-xs-3">
                    <a role="button" class="btn btn-md like tsize-4"><span class="glyphicon glyphicon-thumbs-up text-success"></span> <span class="text-success badge"><?=$bike_keeper->likes?></span></a> 
                ...
                <div class="col-lg-3 col-xs-3">
                    <a role="button" class="btn btn-md dislike tsize-4 disabled"><span class="glyphicon glyphicon-thumbs-down text-danger"></span> <span class="text-danger badge"><?=$bike_keeper->dislikes?></span></a> 
            ...
            <?php if($user_avaliation->rating=='dislikes'): ?>
                <div class="col-lg-3 col-xs-3">
                    <a role="button" class="btn btn-md like tsize-4 disabled"><span class="glyphicon glyphicon-thumbs-up text-success"></span> <span class="text-success badge"><?=$bike_keeper->likes?></span></a> 
                ...
                <div class="col-lg-3 col-xs-3">
                    <a role="button" class="btn btn-md dislike tsize-4"><span class="glyphicon glyphicon-thumbs-down text-danger"></span> <span class="text-danger badge"><?=$bike_keeper->dislikes?></span></a> 
        ...
        <div class="col-lg-6 col-xs-6 top-buffer-1">
            <?php if($bike_keeper->user_id==Yii::$app->user->identity->id): ?>
                <a role="button" class="btn btn-danger btn-sm bike-keeper-disable"><span class="glyphicon glyphicon glyphicon-off text-white tsize-4"></span> <strong><span class="text-white"> Desativar Bicicletário!</span></strong></a> 
                <a role="button" class="btn btn-danger btn-sm bike-keeper-delete hidden"><span class="glyphicon glyphicon glyphicon-trash text-white tsize-4"></span> <strong><span class="text-white"> Excluir Bicicletário!</span></strong></a> 
...
<div class="row top-buffer-1">
    <div class="col-lg-12 col-xs-12">
        <p class="bg-primary text-white text-center"><strong><span class="glyphicon glyphicon glyphicon-comment"></span> Comentários <span class="text-white badge"><?=count($bike_keeper->comments)>0?count($bike_keeper->comments):null?></span></strong></p>
    </div>
</div>
    
<div class="row popup-comment-container">
    <div class="col-lg-12 col-xs-12 wrapper">
        <?php echo Yii::$app->controller->renderPartial('@app/views/bike-keeper-comments/_comments', ['bike-keeper_comments'=>$bike_keeper->comments]);?>
    </div>
</div>
...
<div class="row top-buffer-3">
    ...
    <div class="col-lg-12 col-xs-12 top-buffer-1">
        <?=Html::button("Comentar <span class='glyphicon glyphicon-ok-circle tsize-4'></span>",['class'=>'btn btn-sm btn-success bike-keeper-comment', 'data-loading-text'=>'Enviando...', 'autocomplete'=>'off'])?>
    </div>
</div>    
