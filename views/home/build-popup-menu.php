<ul id='map_menu' class="nav nav-pills nav-stacked">
    ...
    <li><a role="button" data-toggle="modal" data-target="#home_actions_modal" onclick="$('#home_actions_trigger').val($(this).find('span').text()+';bike-keepers')" class="btn btn-default"><span>Guarda Bike</span></a></li>
