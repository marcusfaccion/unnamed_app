<ul id='map_menu' class="nav nav-pills nav-stacked">
    ...
    <li class="nav-active"><a role="button" onclick="userNavigationStart(true, this);" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-screenshot"></span> Ativar navegação</strong></a></li>
    
    <li class="nav-stop" style="display:none"><a role="button" onclick="userNavigationStart(false, this);" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-screenshot"></span> Desativar navegação</strong></a></li>
    
    <li class="nav-uorigin" style="display:none"><a role="button" onclick="setOrigin(me.latLng);map.closePopup(map_popup_menu);" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-map-marker"></span> Meu local como origem</strong></a></li>
