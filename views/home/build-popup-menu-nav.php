<ul id='map_menu' class="nav nav-pills nav-stacked">
    ...
    <li class="nav-disabled" style="display:none"><a role="button" onclick="userNavigationStart(true, this);app.directions.free=true;app.directions.myOrigin=false" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-screenshot"></span> Ativar navegação</strong></a></li>
    
    <li class="nav-enabled"><a role="button" onclick="userNavigationStart(false, this);app.directions.free=false;app.directions.myOrigin=false;" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-screenshot"></span> Desativar navegação</strong></a></li>
    
    <li class="nav-enabled"><a role="button" onclick="setOrigin(me.latLng);app.directions.free=false;app.directions.myOrigin=true; app.directions.pause=true; map.closePopup(map_popup_menu);" class="btn btn-default"><strong><span class="text-muted tsize-4 glyphicon glyphicon-map-marker"></span> Meu local como origem</strong></a></li>
