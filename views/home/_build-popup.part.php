<ul id='map_menu' class="nav nav-pills nav-stacked">
    ...
    <li><a role="button" data-toggle="modal" data-target="#home_actions_modal" onclick="$('#home_actions_trigger').val($(this).find('span').text()+';bike-keeper')" class="btn btn-default"><span>Guardador de bike</span></a></li>
    <li><a role="button" data-toggle="modal" data-target="#home_actions_modal" onclick="$('#home_actions_trigger').val($(this).find('span').text()+';routes')" class="btn btn-default"><span>Rotas</span></a></li>
    ...
    <li><a role="button" data-toggle="modal" data-target="#home_actions_modal" onclick="$('#home_actions_trigger').val($(this).find('span').text()+';renting')" class="btn btn-default"><span>Aluguel de bike</span></a></li>
